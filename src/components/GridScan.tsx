...
export function GridScan({
  ...
  /* used as a fixed full-page background: track the cursor via window,
     since foreground scene layers sit above and would otherwise absorb events */
  useEffect(() => {
  ...
  /* face-api models are only needed for webcam tracking; skip the network fetch otherwise */
  useEffect(() => {
